...
function getPathInfoById(pathID: string) {
  ...
  switch (pathID) {
    case 'art_one':
      cardImg = '/large/listganga1_optimized.png';
      position = { lat: 64.308762, lng: -22.094601 };
      break;
    case 'art_two':
      cardImg = '/large/listganga2_optimized.png';
      position = { lat: 64.320822, lng: -22.076756 };
      break;
    case 'art_three':
      cardImg = '/large/listganga3_optimized.png';
      position = { lat: 64.322397, lng: -22.066692 };
      break;
    case 'art_four':
      cardImg = '/large/listganga4_optimized.png';
      position = { lat: 64.319392, lng: -22.046 };
      break;
    case 'running_three':
      cardImg = '/large/hlaup_optimized.png';
      position = { lat: 64.317597, lng: -22.054151 };
      break;
    case 'beach_one':
      cardImg = '/large/beachwalk1_optimized.png';
      position = { lat: 64.326161, lng: -22.070155 };
      break;
    case 'beach_two':
      cardImg = '/large/beachwalk2_optimized.png';
    ...
    case 'running_two':
      ...
      break;
    case 'bike_one':
      cardImg = '/large/bike1_optimized.png';
      position = { lat: 64.3152673, lng: -22.0618914 };
      break;
    case 'bike_two':
      cardImg = '/large/bike2_optimized.png';
      position = { lat: 64.319856, lng: -22.043744 };
      break;
    default:
      cardImg = '/large/akranes_optimized.png';
      position = { lat: 64.3152673, lng: -22.0618914 };
      break;
  }
  return {
